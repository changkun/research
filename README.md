...
- 🇬🇧 Dennis Dietz, Fabian Berger, **Changkun Ou**, Francesco Chiossi, Giancarlo Graeber, Andreas Butz, and Matthias Hoppe. 2025. VReflect: Evaluating the Impact of Perspectives, Mirrors and Avatars in Virtual Reality Movement Training. In 31st ACM Symposium on Virtual Reality Software and Technology (VRST '25). ACM, New York, NY, USA. [doi:10.1145/3756884.3766021](https://doi.org/10.1145/3756884.3766021). [PDF](https://changkun.de/paper/dietz2025vreflect.pdf)
- 🇬🇧 Oliver Hein, Sebastian Wackerl, **Changkun Ou**, Florian Alt, and Francesco Chiossi. 2025. At the Speed of the Heart: Evaluating Physiologically-Adaptive Visualizations for Supporting Engagement in Biking Exergaming in Virtual Reality. In Proceedings of the First Annual Conference on Human-Computer Interaction and Sport (HCIS '25). ACM, New York, NY, USA. [doi:10.1145/3749385.3749398](https://doi.org/10.1145/3749385.3749398). [PDF](https://changkun.de/paper/hein2025heart.pdf)
- 🇬🇧 Francesco Chiossi, **Changkun Ou**, Felix Putze, and Sven Mayer. 2024. Detecting Internal and External Attention in Virtual Reality: A Comparative Analysis of EEG Classification Methods. In Proceedings of the International Conference on Mobile and Ubiquitous Multimedia (MUM '24). ACM, New York, NY, USA. [doi:10.1145/3701571.3701579](https://doi.org/10.1145/3701571.3701579). [PDF](https://changkun.de/paper/chiossi2024detecting.pdf)
- 🇬🇧 Francesco Chiossi, Yassmine El Khaoudi, **Changkun Ou**, Ludwig Sidenmark, Abdelrahman Zaky, Tiare Feuchtner, and Sven Mayer. 2024. _Evaluating Typing Performance in Different Mixed Reality Manifestations Using Physiological Features_. In Proceedings of the ACM on Human-Computer Interaction 8 (ISS), 377-406. [doi:10.1145/3698142](https://doi.org/10.1145/3698142). [PDF](https://changkun.de/paper/chiossi2024evaluating.pdf)
- 🇬🇧 Dennis Dietz, Fabian Berger, **Changkun Ou**, Francesco Chiossi, Giancarlo Graeber, Andreas Martin Butz, and Matthias Hoppe. 2024. VReflect: Designing VR-Based Movement Training with Perspectives, Mirrors and Avatars. In 30th ACM Symposium on Virtual Reality Software and Technology (VRST '24). ACM, New York, NY, USA. [doi:10.1145/3641825.3687724](https://doi.org/10.1145/3641825.3687724). [PDF](https://changkun.de/paper/dietz2024vreflect.pdf)
- 🇬🇧 Francesco Chiossi, U Gruenefeld, Baoshen James Hou, Joshua Newn, **Changkun Ou**, Rulu Liao, Robin Welsch, Sven Mayer. 2024. _Understanding the Impact of the Reality-Virtuality Continuum on Visual Search Using Fixation-Related Potentials and Eye Tracking Features_. In Proceedings of the ACM on Human-Computer Interaction 8 (MHCI), 1-33. [doi:10.1145/3676528](https://doi.org/10.1145/3676528). [PDF](https://changkun.de/paper/chiossi2024understanding.pdf). [OSF](https://osf.io/fncj4/).
- 🇬🇧 Francesco Chiossi, Ines Trautmannsheimer, **Changkun Ou**, Uwe Gruenefeld, Sven Mayer. 2024. _Searching across Realities: Investigating ERPs and Eye-Tracking Correlates of Visual Search in Mixed Reality_. In IEEE Transactions on Visualization and Computer Graphics (TVCG). [doi:10.1109/TVCG.2024.3456172](https://doi.org/10.1109/TVCG.2024.3456172). [PDF](https://changkun.de/paper/chiossi2024searching.pdf). [OSF](https://osf.io/ar4fs/).
...
- 🇬🇧 Francesco Chiossi, **Changkun Ou**, and Sven Mayer. 2024. Optimizing Visual Complexity for Physiologically-Adaptive VR Systems: Evaluating a Multimodal Dataset Using EDA, ECG and EEG Features. In Proceedings of the 2024 International Conference on Advanced Visual Interfaces (AVI '24). ACM, New York, NY, USA. 🏆 **Best Paper Award**. [doi:10.1145/3656650.3656657](http://doi.org/10.1145/3656650.3656657). [PDF](https://changkun.de/paper/chiossi2024optimizing.pdf).
- 🇬🇧 Rasha M. Amin, Fang Chen, Linus Hirsch, **Changkun Ou**, Tram V. La, Andreas Butz. 2024. Integrating Crowd and Machine Learning in an Intelligent Interface: A Case Study of Oil Spill Detection in Satellite Images. In Proceedings of the 2024 International Conference on Advanced Visual Interfaces (AVI '24). ACM, New York, NY, USA. [doi:10.1145/3656650.3656686](https://doi.org/10.1145/3656650.3656686). [PDF](https://changkun.de/paper/amin2024avi.pdf).
...
- 🇬🇧 Francesco Chiossi, **Changkun Ou**, Sven Mayer. 2023. _Exploring Physiological Correlates of Visual Complexity Adaptation: Insights from EDA, ECG, and EEG Data for Adaptation Evaluation in VR Adaptive Systems_. In Extended Abstracts of the 2023 CHI Conference on Human Factors in Computing Systems (CHI EA '23). ACM, New York, NY, USA, 9 pages. [doi:10.1145/3544549.3585624](https://doi.org/10.1145/3544549.3585624). [PDF](https://changkun.de/paper/eeglbw.pdf). [GitHub](https://github.com/mimuc/vr-adaptation-eeg-evaluation)
- 🇬🇧 Francesco Chiossi, Luke Haliburton, **Changkun Ou**, Andreas Butz, Albrecht Schmidt. 2023. _Short-Form Videos Degrade Our Capacity to Retain Intentions: Effect of Context Switching On Prospective Memory_. In the 2023 ACM Conference on Human-Computer Interaction (CHI'23). ACM, New York, NY, USA, 14 pages. [doi:10.1145/3544548.3580778](https://doi.org/10.1145/3544548.3580778). [PDF](https://changkun.de/paper/tiktok.pdf). [GitHub](https://github.com/mimuc/media-prospective-memory)
- 🇬🇧 Dennis Dietz, Carl Oechsner, **Changkun Ou**, Francesco Chiossi, Fabio Sarto, Sven Mayer, Andreas Butz. 2022. _Walk This Beam: Impact of Different Balance Assistance Strategies and Height Exposure on Performance and Physiological Arousal in VR_. In 28th ACM Symposium on Virtual Reality Software and Technology (VRST '22). ACM, New York, NY, USA, Article 32, 12 pages. 🏆 **[Best Paper Award](https://changkun.de/paper/slackline-cert.pdf)**. [doi:10.1145/3562939.3567818](https://doi.org/10.1145/3562939.3567818). [PDF](https://changkun.de/paper/slackline.pdf). [GitHub](https://github.com/mimuc/walk-this-beam)
...
- 🇬🇧 Yang Li, Eszter Harmat, Mona Mayer, **Changkun Ou**. 2022. _Examining Actual Effects of a Tangible Tool on Children's Collaboration_. In 2022 IEEE International Symposium on Mixed and Augmented Reality Adjunct (ISMAR-Adjunct). IEEE. [doi:10.1109/ISMAR-Adjunct57072.2022.00121](https://doi.org/10.1109/ISMAR-Adjunct57072.2022.00121). [PDF](https://changkun.de/paper/li2022tangible.pdf)
...
- 🇬🇧 **Changkun Ou**. 2024. _The Intelligence in the Loop: Empirical Explorations and Reflections_. Institute of Computer Science. LMU Munich. 151 pages. **Ph.D. Thesis**. [doi:10.5282/edoc.32969](https://doi.org/10.5282/edoc.32969). [PDF](https://changkun.de/thesis/phd.pdf). [YouTube](https://youtu.be/dG8lu7uAyEY).
...
- 🇬🇧 **Changkun Ou**. Apr 3, 2019. _A Glimpse to the Advances of Mesh Representation Learning_. IDC 2019 Spring. [PDF](https://changkun.de/talk/polyred1step.pdf)
- 🇬🇧 **Changkun Ou**. Jan 8, 2019. _Understanding and Predicting Web Clickstreams_. Masters' Defense [PDF](https://changkun.de/talk/master.pdf)
- 🇬🇧 **Changkun Ou**. May 24, 2018. _On the Development of Qualified UX Metric_. Design Workshop II. [PDF](https://changkun.de/talk/qux.pdf)
- 🇬🇧 **Changkun Ou**. Mar 13, 2018. _Capsule Network with Routing Mechanism: Part 2 Matrix Capsules_. LMU Machine Learning Meetup. [PDF](https://changkun.de/talk/capsnet2.pdf)
...
- [CHI (2026) Understanding People — Mixed and Alternative Methods Subcommittee](https://chi2026.acm.org/authors/papers/selecting-a-subcommittee/#understanding_mixed)
...
Copyright &copy; 2016 - 2026 [Changkun Ou](https://changkun.de). All rights reserved.
